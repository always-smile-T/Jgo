...
class _CourseScreenState extends State<CourseScreen>
            ...
            child: Column(
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: const [
                    Text('All Course', style: TextStyle(
                        fontSize: 26, fontWeight: FontWeight.w700
                    ),
                    ),
                  ],
                ...
                SizedBox(
                  ...
                  child: GridView.count(
                    ...
                    primary: false,
                    children: <Widget>[
                      _buildCourse(0,'This is the first course of Learning Japanese N5. In this course, you will learn vocabulary with topics: Country. Furthermore, you learn the grammar N5 in this course.',
                          'Learning Japanese N5 1' , 'N5', 'Country', 'assets/images/j8.png', AppTheme.tagN5 , false,context),
                      _buildCourse(1,'This is the second course of Learning Japanese N5. In this course, you will learn vocabulary with topics: People. Furthermore, you learn the grammar N5 in this course.',
                          'Learning Japanese N5 2' , 'N5', 'People', 'assets/images/j1.png', AppTheme.tagN5 , false,context),
                      _buildCourse(2,'This is the first course of Learning Japanese N4. In this course, you will learn vocabulary with topics: Number and The Week. Furthermore, you learn the grammar N4 in this course.',
                          'Learning Japanese N4 1' , 'N4', 'Number', 'assets/images/j9.png', AppTheme.tagN4 ,true, context),
                      _buildCourse(3,'This is the second course of Learning Japanese N4. In this course, you will learn vocabulary with topics: The Week. Furthermore, you learn the grammar N4 in this course.',
                          'Learning Japanese N4 2' , 'N4', 'Week', 'assets/images/j3.png', AppTheme.tagN4 , true, context),
                      _buildCourse(4,'...updating',
                          'Learning Japanese N3 1' , 'N3', 'Number', 'assets/images/j4.png', AppTheme.tagN3 , false,context),
                      _buildCourse(5,'...updating',
                          'Learning Japanese N2 1' , 'N2', 'Week', 'assets/images/j5.png', AppTheme.tagN2 , true, context),
                      _buildCourse(6,'...updating',
                          'Learning Japanese N1 1' , 'N1', 'Country', 'assets/images/j10.png', AppTheme.tagN1 ,false, context),
                      _buildCourse(7,'...updating',
                          'Learning Japanese N3 1' , 'N3', 'People', 'assets/images/j6.png', AppTheme.tagN3 , false,context),
                      _buildCourse(8,'...updating',
                          'Learning Japanese N2 1' , 'N2', 'People', 'assets/images/j7.png', AppTheme.tagN2 ,false, context),
                      _buildCourse(9,'...updating',
  ...
  Widget _buildCourse(int id, String description,String content,String tag1,String tag2,String image,Color colorT1, bool? liked, context){
    return Padding(
        padding:
