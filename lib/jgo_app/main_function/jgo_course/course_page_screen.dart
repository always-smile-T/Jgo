...
class _CourseScreenState extends State<CourseScreen>
                          ...
                          child: Row(
                            children: [
                              Container(
                                ...
                                child: Text(course[index].nameT1,
                                    textAlign: TextAlign.center),
                              ),
                              Container(
                                width: 65,
  ...
  List<TheCourses> course = [
    // list message demo
    TheCourses(
        courseId: '1',
        content: 'Learning \nJapanese N5 1',
        bgImg: 'assets/images/j8.png',
        liked: false,
        nameT1: 'N5',
        nameT2: 'Country',
        colorT1: AppTheme.tagN5),
    TheCourses(
        courseId: '2',
        content: 'Learning \nJapanese N5 2',
        bgImg: 'assets/images/j1.png',
        liked: false,
        nameT1: 'N5',
        nameT2: 'People',
        colorT1: AppTheme.tagN5),
    ...
    TheCourses(
        courseId: '5',
        content: 'Learning \nJapanese N3 1',
        bgImg: 'assets/images/j4.png',
        liked: false,
        nameT1: 'N3',
        nameT2: 'Number',
        colorT1: AppTheme.tagN3),
    TheCourses(
        courseId: '6',
        content: 'Learning \nJapanese N2 1',
