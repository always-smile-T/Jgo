...
class  _GrammarPageState extends State<GrammarPage> with TickerProviderStateMixin{
  final id;
  int n = 0;
        ...
        child: ListView(children: [
          ...
          Row(
            ...
            children: [
              ...
              const Text('Grammar', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, overflow: TextOverflow.clip),),
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              return Column(
                ...
                children: [
                  const Text('name: ', style: TextStyle(fontWeight: FontWeight.bold, decoration: TextDecoration.underline, fontSize: 16),),
                  const SizedBox(height: 5,),
                  Text(grammar[n].name, style: const TextStyle(fontWeight: FontWeight.w600),),
                  const SizedBox(height: 5,),
                  const Text('description: ', style: TextStyle(fontWeight: FontWeight.bold, decoration: TextDecoration.underline, fontSize: 16),),
                  const SizedBox(height: 5,),
                  Text(grammar[n].description, style: const TextStyle(fontWeight: FontWeight.w600),),
                  const SizedBox(height: 5,),
                  const Text('example: ', style: TextStyle(fontWeight: FontWeight.bold, decoration: TextDecoration.underline, fontSize: 16),),
                  const SizedBox(height: 5,),
                  Text(grammar[n].example, style: const TextStyle(fontWeight: FontWeight.w600),),
                  const SizedBox(height: 5,),
                  const Text('note: ', style: TextStyle(fontWeight: FontWeight.bold, decoration: TextDecoration.underline, fontSize: 16),),
                  const SizedBox(height: 5,),
                  Text(grammar[n].note, style: const TextStyle(fontWeight: FontWeight.w600),),
                  const SizedBox(height: 5,)
  ...
  'です(desu) is are polite form of the verb to be. The polite form is the default on more formal occasions and between people of different stature, such as a teacher and a student, and also between strangers.’'
    ...
    TheGramar(
        name:'~は~ではありません',
        description: 'N1 は(Wa)　N2 ではありません(dewa arimasen)。\nEnglish: N1 is not N2\n'
...
class TheGramar{
  ...
  String example;
  String note;
  TheGramar({required this.name, required this.description, required this.example, required this.note,});
}
