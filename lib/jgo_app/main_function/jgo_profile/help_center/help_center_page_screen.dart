...
class _HelpCenterPageScreenState extends State<HelpCenterPageScreen> {
                ...
                children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        IconButton(
                            ...
                            icon:
                                Image.asset("assets/images/more_options.png")),
                      ],
                    ),
                  ),
                  Padding(
                  ...
                  Container(
                    decoration: BoxDecoration(
                        ...
                        border:
                            Border.all(width: 2, color: AppTheme.greenPrimary)),
                    height: 450,
                                    ...
                                    children: [
                                      SizedBox(
                                        height: messages[index].messageType ==
                                            ...
                                            ? 24
                                            : 0,
                                        width: messages[index].messageType ==
                                                "suggest"
                                            ? 24
                                            : 0,
                                        child: Image.asset(
  ...
  List<ChatMessage> messages = [
    // list message demo
    ChatMessage(
        messageContent: "why should i pay for this app?",
        messageType: "suggest"),
    ChatMessage(
        messageContent: "When is the monthly renewal?", messageType: "suggest"),
    ChatMessage(messageContent: "Can not receive", messageType: "suggest"),
    ChatMessage(
        messageContent: "Can i pay via e-wallet?", messageType: "suggest"),
    ChatMessage(
        messageContent: "How is the fee charged?", messageType: "suggest"),
    ChatMessage(
        messageContent: "Payment & Subscriptions (5)", messageType: "title"),
    ChatMessage(
        messageContent: "Quick Tips: Be a friend with JGo app",
        messageType: "suggest"),
    ChatMessage(
        messageContent: "How is JGo different from other apps?",
        messageType: "suggest"),
    ChatMessage(
        messageContent: "Do I have to sign up or sign in to use JGo?",
        messageType: "suggest"),
    ChatMessage(
        messageContent: "Getting Started with JGo(3)", messageType: "title"),
    ChatMessage(
        messageContent: "why should i pay for this app?",
        messageType: "suggest"),
    ChatMessage(
