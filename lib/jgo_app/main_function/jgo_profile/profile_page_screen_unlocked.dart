                              ...
                              child: Stack(
                                ...
                                children: <Widget>[
                                 ...
                                 const Positioned(
                                    bottom: 72,
                                    left: 50,
                                    child:Text('0 cents', style: TextStyle(
                                    ...
                                    child:  Container(
                                      ...
                                      height: 25,
                                        child: IconButton(
                                          ...
                                          icon: Image.asset('assets/images/wallet_icon1.png'),
                                         ///// ++++++++ loi
                                        ),
                                    ),
                                  ),
                                ...
                                children: [
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      child: ElevatedButton(
                                          child: Image.asset("assets/images/friends_button1.png"),
                                          onPressed: (){
                                          },
                                          style: ButtonStyle(
                                  ...
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      height: 30,
                                      child: ElevatedButton(
                                          child: Image.asset("assets/images/voucher_button1.png"),
                                          onPressed: (){
                                          },
                                          style: ButtonStyle(
                                              shape: MaterialStateProperty.all<
                                    ...
                                    child: Container(
                                      ...
                                      height: 30,
                                      child: ElevatedButton(
                                          child: Image.asset("assets/images/month_button1.png"),
                                          onPressed: (){
                                            Navigator.of(context).pushAndRemoveUntil(
                                                MaterialPageRoute(
                                                    builder: (BuildContext context) =>
                                        ...
                                        children: [
                                          Expanded(
                                            ...
                                            child: Container(
                                                ...
                                                child: const Center(
                                                  child: Text('Favourite Words', style: TextStyle(
                                                      fontSize: 16, color: AppTheme.greenPrimary
                                                  ),),
                                                )
                                            ),),
                                          Expanded(
                                        ...
                                        children: [
                                          Expanded(
                                            ...
                                            child: Container(
                                                ...
                                                child: const Center(
                                                  child: Text('Bookcase', style: TextStyle(
                                                      fontSize: 16, color: AppTheme.greenPrimary
                                                  ),),
                                                )
                                            ),),
                                                ...
                                                children: [
                                                  Positioned(
                                                      ...
                                                      child: SizedBox(
                                                        height: 70,
                                                        width: 70,
                                                        child: Image.asset('assets/images/bookdecor.png'),
                                                      )
                                                  ),
                                                  Positioned(
                                                      left: 1,
                                                  ...
                                                  Positioned(
                                                      ...
                                                      child: SizedBox(
                                                        height: 95,
                                                        width: 95,
                                                        child: Image.asset('assets/images/unlocked.png', ),
                                                      )
                                                  ),
                                                ],
                                              ),
                                        ...
                                        children: [
                                          Expanded(
                                            ...
                                            child: Container(
                                                ...
                                                child: const Center(
                                                  child: Text('Favourite Courses', style: TextStyle(
                                                      fontSize: 16, color: AppTheme.greenPrimary
                                                  ),),
                                                )
                                            ),
                                ...
                                Row(
                                  ...
                                  children: [
                                    ElevatedButton(
                                        ...
                                        onPressed: (){
                                          Navigator.of(context).pushAndRemoveUntil(
                                              MaterialPageRoute(builder: gotoSignIn), (route) => false);},
                                        style: ButtonStyle(
                                            shape: MaterialStateProperty.all<
                                                RoundedRectangleBorder>(
                                                RoundedRectangleBorder(
                                    ...
                                    const Text('or', style: TextStyle(fontSize: 16, color: AppTheme.greenPrimary)),
                                    ElevatedButton(
                                        child: Center(
                                          child: Stack(
                                            children: <Widget>[
